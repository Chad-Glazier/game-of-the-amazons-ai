...
This project is meant to implement a simple AI to play the [Game of the Amazons](https://en.wikipedia.org/wiki/Game_of_the_Amazons). The written report for EDI can be found [here](./EDI_Report.pdf).
